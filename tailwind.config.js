  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'home-gradient': 'linear-gradient(to bottom right, #362448, #FFFFFF)',
        'toolbar-gradient': '`linear-gradient(to bottom right, #1F3054, #211043)`',
        'icon-gradient': 'linear-gradient(to bottom, #EEEEFF, #F6F7FF)',
      },
      borderRadius: {
        lg: 'var(--radius)',
