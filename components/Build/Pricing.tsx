...
function formatPrice(basePrice: number) {
  try {
    ...
    if (userRegion.includes('GB')) {
      return `£${basePrice}`
    } else if (userRegion.includes('EU') || /^[a-z]{2}-[A-Z]{2}/.test(userRegion)) {
      return `€${basePrice}`
    }
      ...
      <Container>
        <div className="md:text-center">
          ...
          <p className="mt-4 text-lg text-slate-400">
            Simple, affordable pricing. Make changes to your website whenever you need to.
          </p>
        </div>
        <div className="mt-16 flex justify-center">
          <Plan
            ...
            name="Per Month"
            price={99}
            description="Includes ongoing updates to your website."
            href="/create"
            features={[
              'Advanced SEO optimization',
              'World class ongoing support',
              'Custom gym timetable',
              'Drop-in booking system',
