      ...
      <Container>
        <div className="md:text-center">
          ...
          <p className="mt-4 text-lg text-slate-400">
            We scale with you. Our incentive is to help you sell more tickets so we make
            more too.
          </p>
        </div>
        <div className="mt-16 flex justify-center">
          <Plan
            featured
            name="Per Ticket Sold"
            price="4% plus £2"
            description="Only pay when you sell tickets."
            href="/create"
            features={[
              'Create a custom event page',
              'Live leaderboard',
              'Highly customisable heats',
              'Accept Apple Pay, Google Pay, Stripe Link',
              'Athletes can select their heat times',
